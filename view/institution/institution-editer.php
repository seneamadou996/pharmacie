...
<?php 
    ...
    $ps=$req->prepare("SELECT * FROM clients");
    $ps->execute();
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row cont collapsed">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                                    <div class="bg-white py-2 collapse-inner rounded">
                                        ...
                                        <a class="collapse-item" href="index.php">Institution</a>
                    ...
                    <div class="col-9">
                        <h2 class="page-header text-white mt-5">id
                            <?php echo $institution->id != null ? $institution->id : ' Nouvel Enregistrement'; ?>
                        </h2>
                        <hr class="bg-white">
                        <div class="container mt-5">
                        <form id="frm-alumno" action="?c=institution&a=Enregistrer" method="post" enctype="multipart/form-data">
                            <div class="row mb-3">
                                <div class="col">
                                <input type="hidden" class="form-control" value="<?php echo $institution->id; ?>" name="id">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col">
                                <input type="number" class="form-control" value="<?php echo $institution->taux_pris_charge; ?>" name="taux_pris_charge" placeholder="taux de prix en charge" required>
                                </div>
                                <div class="col">
                                <input type="number" class="form-control" value="<?php echo $institution->fidelite; ?>" name="fidelite" placeholder="fidelite" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <select name="clients_id" id="clients_id" class="form-group ml-2 mt-2">
                                    <option class="form-control" value="<?php echo $institution->clients_id; ?>">Selectionnez un client</option>
