                ...
                <div class="row cont collapsed">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                                    <div class="bg-white py-2 collapse-inner rounded">
                                        ...
                                        <a class="collapse-item" href="index.php">Liste de fournisseurs</a>
                    ...
                    <div class="col-9">
                        <h2 class="page-header text-white mt-5">id
                            <?php echo $fournisseur->id != null ? $fournisseur->code : ' Nouvel Enregistrement'; ?>
                        </h2>
                        <hr class="bg-white">
                        ...
                        <form id="frm-alumno" action="?c=fournisseur&a=Enregistrer" method="post" enctype="multipart/form-data">
                            <div class="row mb-3">
                                <div class="col">
                                <input type="hidden" class="form-control" value="<?php echo $fournisseur->id; ?>" name="id">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                <input type="text" class="form-control" value="<?php echo $fournisseur->code; ?>" name="code" placeholder="Code" required>
                                </div>
                                <div class="col">
                                <input type="text" class="form-control" value="<?php echo $fournisseur->denomination; ?>" name="denomination" placeholder="Dénomination" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col">
                                <input type="text" class="form-control" value="<?php echo $fournisseur->adresse; ?>" name="adresse" placeholder="Adresse" required>
                                </div>
                                <div class="col">
                                <input type="text" class="form-control" value="<?php echo $fournisseur->telephone; ?>" name="telephone" placeholder="Téléphone" required>
                                </div>
                            </div>
