...
<?php 
    ...
    $ps=$req->prepare("SELECT * FROM familles");
    $ps->execute();
    $ps1=$req->prepare("SELECT * FROM formes");
    $ps1->execute();
                ...
                <div class="row cont collapsed">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                                    <div class="bg-white py-2 collapse-inner rounded">
                                        ...
                                        <a class="collapse-item" href="index.php">Produit</a>
                    ...
                    <div class="col-9">
                        <h2 class="page-header text-white mt-5">id
                            <?php echo $produit->id != null ? $produit->libelle : ' Nouvel Enregistrement'; ?>
                        </h2>
                        <hr class="bg-white">
                        <div class="container mt-5">
                        <form id="frm-alumno" action="?c=produit&a=Enregistrer" method="post" enctype="multipart/form-data">
                            <div class="row mb-3">
                                <div class="col">
                                <input type="hidden" class="form-control" value="<?php echo $produit->id; ?>" name="id">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                <input type="text" class="form-control" value="<?php echo $produit->libelle; ?>" name="libelle" placeholder="Libelle" required>
                                </div>
                                <div class="col">
                                <input type="text" class="form-control " value="<?php echo $produit->description; ?>" name="description" placeholder="Description" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col">
                                <input type="text" class="form-control mb-3" value="<?php echo $produit->rayon; ?>" name="rayon" placeholder="Rayon" required>
                                </div>
                                <div class="col">
                                <input type="text" class="form-control mb-3" value="<?php echo $produit->etage; ?>" name="etage" placeholder="Etage" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col">
                                <input type="text" class="form-control mb-3" value="<?php echo $produit->prix_achat; ?>" name="prix_achat" placeholder="Prix d'achat" required>
                                </div>
                                <div class="col">
                                <input type="text" class="form-control mb-3" value="<?php echo $produit->prix_vente; ?>" name="prix_vente" placeholder="Prix de vente" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col">
                                <select name="familles_id" id="famille" class="form-group">
                                    <option value="<?php echo $produit->familles_id; ?>">Selectionnez une famille</option>
                                    <?php while($i=$ps->fetch()) { ?>
                                        <option class="form-control" value="<?php echo($i['id'])?>"><?php echo($i['code'])?></option>
                                    <?php } ?>
                                </select>
                                </div>
                                <div class="col">
                                <select name="formes_id" id="forme" class="form-group">
                                    <option class="form-control" value="<?php echo $produit->formes_id; ?>">Selectionnez une forme</option>
                                    <?php while($i=$ps1->fetch()) { ?>
                                        <option class="form-control" value="<?php echo($i['id'])?>"><?php echo($i['forme'])?></option>
                                    <?php } ?>
                                </select>
                                </div>
                            </div>
                            <div class="form-row float-right mt-2 mb-2">
                                <div class="col">
