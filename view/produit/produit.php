        ...
        <div class="card">
            ...
            <div class="card-body bg-dark">
                <div class="row cont collapsed">
                        ...
                        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                                    <div class="bg-white py-2 collapse-inner rounded">
                                        ...
                                        <a class="collapse-item" href="../fournisseur/index.php">Liste des fournisseurs</a>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="collapseT" class="collapse" aria-labelledby="headingT" data-parent="#accordionSidebar">
                                    <div class="bg-white py-2 collapse-inner rounded">
                                        <h6 class="collapse-header">clické une option:</h6>
                                        <a class="collapse-item" href="../reglement-four/index.php">Réglement produit</a>
                    ...
                    <div class="col-9">
                        <div class="row">
                            <div class="col col-6 mt-3 text-white"><h3>Liste des Médicaments</h3></div>
                            <div class="col col-6"><a class="btn btn-primary float-right mt-3" href="?c=produit&a=Crud">Ajouter</a></div>
                        </div>
                        <hr class="bg-white">
                        <table id="myTable" class="table table-striped  bg-white">
                            ...
                            <?php foreach($this->model->Lister() as $r): ?>
                                <tr>
                                    ...
                                    <td><?php echo $r->etage; ?></td>
                                    <td><?php echo $r->prix_achat; ?></td>
                                    <td><?php echo $r->prix_vente; ?></td>
                                    <td><?php echo $r->code; ?></td>
                                    <td><?php echo $r->forme; ?></td>
                                    <td>
                                    <a href="?c=Produit&a=Crud&id=<?php echo $r->id; ?>"><i class="fas fa-pen text-primary pr-2" style="font-size:20px"></i></a>
                                    <a onclick="javascript:return confirm('Voulez-vous vraiment supprimer cet enregistrement?');" href="?c=Produit&a=Supprimer&id=<?php echo $r->id; ?>"><i class="fas fa-times text-danger" style="font-size:24px" ></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
		                    </tbody>
