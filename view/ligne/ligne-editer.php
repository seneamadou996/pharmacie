...
<?php
    ...
    $ps=$req->prepare("SELECT prenom,nom,pharmaciens.id FROM users  INNER JOIN  pharmaciens ON users.id=pharmaciens.users_id");
    $ps->execute();
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row cont collapsed">
                        ...
                        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
                            ...
                            <li class="nav-item">
                                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                                    <i class="fas fa-pharmacien-friends"></i>
                                ...
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                                    <div class="bg-white py-2 collapse-inner rounded">
                                        ...
                                        <a class="collapse-item" href="index.php">Ligne de commande</a>
                    ...
                    <div class="col-9">
                        <h2 class="page-header text-white mt-5">id
                            <?php echo $ligne->id != null ? $ligne->id : ' Nouvel Enregistrement'; ?>
                        </h2>
                        <hr class="bg-white">
                        <div class="container mt-5">
                        <form id="frm-alumno" action="?c=ligne&a=Enregistrer" method="post" enctype="multipart/form-data">
                            <div class="row mb-3">
                                <div class="col">
                                <input type="hidden" class="form-control" value="<?php echo $ligne->id; ?>" name="id">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                    <input type="number" class="form-control" value="<?php echo $ligne->numero; ?>" name="numero" placeholder="Numéro" required>
                                </div>
                                <div class="col">
                                    <select name="pharmaciens_id" id="pharmaciens_id" class="form-group mt-1">
