        ...
        <div class="card">
            ...
            <div class="card-body bg-dark">
                <div class="row cont collapsed">
                    ...
                    <div class="col-9">
                        <div class="row">
                            <div class="col col-6 mt-3 text-white"><h3>Liste des lignes de commande</h3></div>
                            <div class="col col-6"><a class="btn btn-primary float-right mt-3" href="?c=ligne&a=Crud">Ajouter</a></div>
                        </div>
                        <hr class="bg-white">
                        <table id="myTable" class="table table-striped  bg-white">
                            ...
                            <?php foreach($this->model->Lister() as $r): ?>
                                <tr>
                                    ...
                                    <td>
                                    <a href="?c=ligne&a=Crud&id=<?php echo $r->id; ?>"><i class="fas fa-pen text-primary pr-2" style="font-size:20px"></i></a>
                                    <a onclick="javascript:return confirm('Voulez-vous vraiment supprimer cet enregistrement?');" href="?c=ligne&a=Supprimer&id=<?php echo $r->id; ?>"><i class="fas fa-times text-danger" style="font-size:24px" ></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
		                    </tbody>
