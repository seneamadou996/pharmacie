...
<?php
    ...
    $ps=$req->prepare("SELECT * FROM users");
    $ps->execute();
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row cont collapsed">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="collapseTw" class="collapse" aria-labelledby="headingTw" data-parent="#accordionSidebar">
                                    <div class="bg-white py-2 collapse-inner rounded">
                                        ...
                                        <a class="collapse-item" href="index.php">pharmacien</a>
                    ...
                    <div class="col-9">
                        <h2 class="page-header text-white mt-5">id
                            <?php echo $pharmacien->id != null ? $pharmacien->id : ' Nouvel Enregistrement'; ?>
                        </h2>
                        <hr class="bg-white">
                        <div class="container mt-5">
                        <form id="frm-alumno" action="?c=pharmacien&a=Enregistrer" method="post" enctype="multipart/form-data">
                            <div class="row mb-3">
                                <div class="col">
                                <input type="hidden" class="form-control" value="<?php echo $pharmacien->id; ?>" name="id">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                <input type="text" class="form-control" value="<?php echo $pharmacien->adresse; ?>" name="adresse" placeholder="adresse" required>
                                </div>
                                <div class="col">
                                    <select name="users_id" id="users_id" class="form-group mt-1">
                                        <option class="form-control" value="<?php echo $pharmacien->users_id; ?>">Selectionnez un utilisateur</option>
                                        <?php while($i=$ps->fetch()) { ?>
                                            <option class="form-control" value="<?php echo($i['id'])?>"><?php echo($i['email'])?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
