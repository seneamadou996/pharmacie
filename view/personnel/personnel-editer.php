                ...
                <div class="row cont collapsed">
                    ...
                    <div class="col-9">
                        <h2 class="page-header text-white mt-5">id
                            <?php echo $personnel->id != null ? $personnel->id : ' Nouvel Enregistrement'; ?>
                        </h2>
                        <hr class="bg-white">
                        <div class="container mt-5">
                        <form id="frm-alumno" action="?c=personnel&a=Enregistrer" method="post" enctype="multipart/form-data">
                            <div class="row mb-3">
                                <div class="col">
                                <input type="hidden" class="form-control" value="<?php echo $personnel->id; ?>" name="id">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                <input type="text" class="form-control" value="<?php echo $personnel->adresse; ?>" name="adresse" placeholder="adresse" required>
                                </div>
                                <div class="col">
                                    <select name="users_id" id="users_id" class="form-group mt-1">
                                        <option class="form-control" value="<?php echo $personnel->users_id; ?>">Selectionnez un employés</option>
