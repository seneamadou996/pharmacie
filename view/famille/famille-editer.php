                ...
                <div class="row cont collapsed">
                    ...
                    <div class="col-9">
                        <h2 class="page-header text-white mt-5">Id
                            <?php echo $famille->id != null ? $famille->code : ' Nouvel Enregistrement'; ?>
                        </h2>
                        <hr class="bg-white">
                        <div class="container mt-5">
                        <form id="frm-alumno" action="?c=famille&a=Enregistrer" method="post" enctype="multipart/form-data">
                            <div class="row mb-3">
                                <div class="col">
                                <input type="hidden" class="form-control" value="<?php echo $famille->id; ?>" name="id">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                <input type="text" class="form-control" value="<?php echo $famille->code; ?>" name="code" placeholder="Code" required>
                                </div>
                                <div class="col">
                                <input type="text" class="form-control" value="<?php echo $famille->famille; ?>" name="famille" placeholder="famille" required>
                                </div>
                            </div>
