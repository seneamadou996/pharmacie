...
<?php 
    ...
    $ps=$req->prepare("SELECT DISTINCT date FROM depenses ORDER BY date DESC");
    $ps->execute();
    $ps2=$req->prepare("SELECT DISTINCT date FROM depenses ORDER BY date DESC");
    $ps2->execute();
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="card">
            ...
            <div class="card-body bg-dark">
                <div class="row cont collapsed">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                                    <div class="bg-white py-2 collapse-inner rounded">
                                        ...
                                        <a class="collapse-item" href="../ligne/index.php">ligne commande</a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="collapseT" class="collapse" aria-labelledby="headingT" data-parent="#accordionSidebar">
                                    <div class="bg-white py-2 collapse-inner rounded">
                                        ...
                                        <a class="collapse-item" href="index.php">Dépenses</a>
                    ...
                    <div class="col-9">
                        <div class="row">
                            <div class="col col-6 mt-3 text-white"><h3>Gestion des dépenses</h3></div>
                            <div class="col col-6"><a class="btn btn-primary float-right mt-3" href="?c=depense&a=Crud">Ajouter</a></div>
                        </div>
                        <hr class="bg-white">
                        <table id="myTable" class="table table-striped  bg-white">
                            ...
                            <?php foreach($this->model->Lister() as $r): ?>
                                <tr>
                                    ...
                                    <td>
                                    <a href="?c=depense&a=Crud&id=<?php echo $r->id; ?>"><i class="fas fa-pen text-primary pr-2" style="font-size:20px"></i></a>
                                    <a onclick="javascript:return confirm('Voulez-vous vraiment supprimer cet enregistrement?');" href="?c=depense&a=Supprimer&id=<?php echo $r->id; ?>"><i class="fas fa-times text-danger" style="font-size:24px" ></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
		                    </tbody>
                        ...
                        <div class="container col-md-6 offset-3">
                            <form action="detail_depense.php" method="post" target="_blank">
                                <div class="row">
                                    <div class="form-group col col-md-4 mt-1">
                                        <select name="date1" id="date1">
                                            <?php while ($i=$ps->fetch()) {?>
                                                <option value="<?php echo($i['date']) ?>"><?php echo($i['date']) ?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                                    <div class="form-group col col-md-4 mt-1 ">
                                        <select name="date2" id="date1">
                                    ...
                                    <div class=" col col-md-2 mb-2 ">
                                        <button type="submit" name="detail">Imprimer</button>
                                    </div>
                                </div>
