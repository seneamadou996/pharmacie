                ...
                <div class="row cont collapsed">
                    ...
                    <div class="col-9">
                        <h2 class="page-header text-white mt-5">id
                            <?php echo $depense->id != null ? $depense->id : ' Nouvel Enregistrement'; ?>
                        </h2>
                        <hr class="bg-white">
                        <div class="container mt-5">
                        <form id="frm-alumno" action="?c=depense&a=Enregistrer" method="post" enctype="multipart/form-data">
                            <div class="row mb-3">
                                <div class="col">
                                <input type="hidden" class="form-control" value="<?php echo $depense->id; ?>" name="id">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                <input type="text" class="form-control" value="<?php echo $depense->intitule; ?>" name="intitule" placeholder="Motif de la dépense" required>
                                </div>
                                <div class="col">
                                <input type="text" class="form-control" value="<?php echo $depense->montant; ?>" name="montant" placeholder="Montant de la dépense" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
