...
<?php
    ...
    $ps=$req->prepare("SELECT * FROM roles");
    $ps->execute();
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row cont collapsed">
                        ...
                        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="collapseTw" class="collapse" aria-labelledby="headingTw" data-parent="#accordionSidebar">
                                    <div class="bg-white py-2 collapse-inner rounded">
                                        <h6 class="collapse-header">clické une option:</h6>
                                        <a class="collapse-item" href="index.php">Utilisateur</a>
                    ...
                    <div class="col-9">
                        ...
                        <form id="frm-alumno" action="?c=utilisateur&a=Enregistrer" method="post" enctype="multipart/form-data">
                            <div class="row mb-3">
                                <div class="col">
                                <input type="hidden" class="form-control" value="<?php echo $utilisateur->id; ?>" name="id">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                <input type="text" class="form-control" value="<?php echo $utilisateur->nom; ?>" name="nom" placeholder="Nom" required>
                                </div>
                                <div class="col">
                                <input type="text" class="form-control" value="<?php echo $utilisateur->prenom; ?>" name="prenom" placeholder="Prénom" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col">
                                <input type="text" class="form-control" value="<?php echo $utilisateur->telephone; ?>" name="telephone" placeholder="Téléphone" required>
                                </div>
                                <div class="col">
                                <input type="email" class="form-control" value="<?php echo $utilisateur->email; ?>" name="email" placeholder="email" required>
                                </div>
                            </div>
                            <div class="form-row mt-3">
                                <div class="col">
                                    <select name="roles_id" id="roles_id" class="form-group">
                                        <option class="form-control" value="<?php echo $utilisateur->roles_id; ?>">Selectionnez un rôle</option>
                                        <?php while($i=$ps->fetch()) { ?>
                                            <option class="form-control" value="<?php echo($i['id'])?>"><?php echo($i['role'])?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="col">
                                <input type="password" class="form-control" value="<?php echo $utilisateur->password; ?>" name="password" placeholder="password" maxlength="8" required>
                                </div>
                            </div>
