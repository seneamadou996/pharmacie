...
<?php 
    ...
    $ps=$req->prepare("SELECT * FROM types");
    $ps->execute();
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row cont collapsed">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                                    <div class="bg-white py-2 collapse-inner rounded">
                                        ...
                                        <a class="collapse-item" href="index.php">Client</a>
                    ...
                    <div class="col-9">
                        ...
                        <form id="frm-alumno" action="?c=client&a=Enregistrer" method="post" enctype="multipart/form-data">
                            <div class="row mb-3">
                                <div class="col">
                                <input type="hidden" class="form-control" value="<?php echo $client->id; ?>" name="id">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                <input type="text" class="form-control" value="<?php echo $client->denomination; ?>" name="denomination" placeholder="denomination" required>
                                </div>
                                <div class="col">
                                <input type="text" class="form-control" value="<?php echo $client->adresse; ?>" name="adresse" placeholder="adresse du client" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col">
                                <input type="text" class="form-control" value="<?php echo $client->telephone; ?>" name="telephone" placeholder="téléphone du client" required>
                                </div>
                                <div class="col">
                                <select name="types_id" id="types_ids" class="form-group">
                                    <option class="form-control" value="<?php echo $client->types_id; ?>">Selectionnez un type</option>
                                    <?php while($i=$ps->fetch()) { ?>
                                        <option class="form-control" value="<?php echo($i['id'])?>"><?php echo($i['type'])?></option>
                                    <?php } ?>
                                </select>
                                </div>
                            </div>
