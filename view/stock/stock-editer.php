                ...
                <div class="row cont collapsed">
                    ...
                    <div class="col-9">
                        <h2 class="page-header text-white mt-5">id
                            <?php echo $stock->id != null ? $stock->id : ' Nouvel Enregistrement'; ?>
                        </h2>
                        <hr class="bg-white">
                        <div class="container mt-5">
                        <form id="frm-alumno" action="?c=stock&a=Enregistrer" method="post" enctype="multipart/form-data">
                            <div class="row mb-3">
                                <div class="col">
                                <input type="hidden" class="form-control" value="<?php echo $stock->id; ?>" name="id">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                <input type="text" class="form-control" value="<?php echo $stock->libelle_stock; ?>" name="libelle_stock" placeholder="Libellé du stock" required>
                                </div>
                                <div class="col ">
                                <input type="number" class="form-control" value="<?php echo $stock->quantite_max; ?>" name="quantite_max" placeholder="La quantité maximale" required>
                                </div>
                            </div>
