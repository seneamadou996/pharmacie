<?php
    ...
    $pdo = new PDO('mysql:host=localhost;dbname=monpharmacie;charset=utf8', 'root', '');
...
<head>
    ...
    <title>Gestion pharmacie connexion</title>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block">
                                <img src="assets/img/images1.jpg" alt="logo" width="100%" height="100%">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Gestion pharmacie</h1>
                                    </div>
                                    <form action="index.php" method="post">
                                        ...
                                        <input type="submit" name="ok" value="Se Connecter" class="btn btn-primary btn-user btn-block">
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="view/exemple/forgot-password.html">Mot de passe oublié?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
